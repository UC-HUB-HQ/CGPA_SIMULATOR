  ...
  return(
    <section>
      ...
      <div className="flex flex-col items-center justify-center mt-10 ">
        ...
        <a rel="canonical" href={`https://twitter.com/intent/tweet?text=${message}`} class="twitter-share-button flex items-center justify-center gap-2 px-5 py-3 mt-6 rounded-full bg-primary-700 mobile:mt-4" data-size="large" data-text={`I tried the UC Hub CGPA calculator, here's my score: ${cgpa}. You should try it out too`} data-via="@uc_hub_" data-hashtags="uchub cgpacalculator" data-url=" "  data-show-count="false">
