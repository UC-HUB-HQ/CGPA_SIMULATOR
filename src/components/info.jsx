const Info = ({cgpa}) => {
  ...
  const message = `I tried the UC Hub CGPA calculator, here's my score: ${cgpa}. You should try it out too.`
  ...
  return(
    <section>
      ...
      <div className="flex flex-col items-center justify-center mt-10 ">
        ...
        <a href={`http://twitter.com/share?&url=&text=${message}&hashtags=uchub,cgpacalculator`} className="flex items-center justify-center gap-2 px-5 py-3 mt-6 rounded-full bg-primary-700 mobile:mt-4">
